...
`exportedKwh` bleibt die Brutto-Einspeisung gemäss Zähler/App. `neighborExportKwh` wird davon abgezogen und separat als Nachbar/Solarsplit ausgewiesen. Für diesen Anteil rechnet die App fix mit 20 Rp./kWh.
