...
- `electricityPrice`
- `feedInTariff`
- `neighborExportKwh`  ← Solarsplit/Nachbarbezug gemäss EW-Abrechnung, z. B. alle 3 Monate
...
`exportedKwh` bleibt die Brutto-Einspeisung gemäss Zähler/App. `neighborExportKwh` wird davon abgezogen und separat als Nachbar/Solarsplit ausgewiesen. Für diesen Anteil rechnet die App fix mit 20 Rp./kWh brutto abzüglich 3.25 Rp./kWh Dienstleistung. In der Netto-Ersparnis wird nur der Solarsplit-Nettobetrag berücksichtigt.
